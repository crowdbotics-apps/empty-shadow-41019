"""
Django settings for empty_shadow_41019 project.
...
ROOT_URLCONF = 'empty_shadow_41019.urls'
...
WSGI_APPLICATION = 'empty_shadow_41019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_shadow_41019 API",
    "DESCRIPTION": "API documentation for empty_shadow_41019 App",
    "VERSION": "v1",
}
